...
export const accountLabels: Record<AccountType, string> = {
  cash: 'Cash', bank: 'Bank', upi: 'UPI', debit_card: 'Debit card', credit_card: 'Credit card', wallet: 'Wallet', custom: 'Custom',
};
...
export function createTransaction(input: Omit<Transaction, 'id' | 'createdAt' | 'updatedAt'>): Transaction {
